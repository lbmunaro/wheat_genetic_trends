---
title: 'Genetic trends due to 21 years of winter wheat breeding at the University of Illinois'
author:
...
gt_dat |> filter(var=="grain_yield") |>
  ...
  theme(axis.text.x = element_text(angle = 45, hjust=1, vjust=1, size = 12),
        ...
        axis.title.y = element_text(size = 14),
        legend.position = 'none', panel.grid = element_blank())
ggsave("figures/gy.png", width = 6, height = 4, units = "in", dpi=320)
```
##### Test weight
...
gt_dat |> filter(var=="test_weight") |>
  ...
  theme(axis.text.x = element_text(angle = 45, hjust=1, vjust=1, size = 12),
        ...
        axis.title.y = element_text(size = 14),
        legend.position = 'none', panel.grid = element_blank())
ggsave("figures/tw.png", width = 6, height = 4, units = "in", dpi=320)
```
...
gt_dat |> filter(var=="heading_time") |>
  ...
  theme(axis.text.x = element_text(angle = 45, hjust=1, vjust=1, size = 12),
        ...
        axis.title.y = element_text(size = 14),
        legend.position = 'none', panel.grid = element_blank())
ggsave("figures/ht.png", width = 6, height = 4, units = "in", dpi=320)
```
